...
**YOU ARE IN: `kanban/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/kanban/` (rig root) or other directories
...
**Your mail address:** `kanban/polecats/obsidian`
**Your rig:** kanban
**Your Witness:** `kanban/witness`
...
| Ask Witness for help | `gt mail send kanban/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`kanban/witness`) when:
...
```bash
gt mail send kanban/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
